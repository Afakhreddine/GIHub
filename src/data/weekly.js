...
const weekly = [
  ...
  },
  {
    ...
    "authors": "",
    "source": "news.gastro.org",
    "summary": "Multicountry population-based randomized invitation trial (NordICC), intention-to-screen analysis; Screening-naive adults aged 55-64 years in Norway, Poland, and Sweden; 84,583 participants; median follow-up 13 years. CRC risk was 1.46% with invitation versus 1.80% without invitation (19% relative reduction; 0.34-percentage-point absolute reduction; number needed to invite 294); only 42% of invitees underwent colonoscopy. CRC mortality was 0.41% versus 0.47% (estimated 12% relative reduction), a difference that was not statistically significant; all-cause mortality was 16.30% versus 16.34%. Strengthens evidence that one-time colonoscopy invitation reduces CRC incidence, while counseling should distinguish relative benefit from the modest absolute reduction and unproven mortality benefit at 13 years. Limitation: Low participation diluted the intention-to-screen effect, the study remained underpowered for CRC mortality, and some control-group screening could not be excluded. Source verified; AI-assisted summary requires human review before merge.",
    "url": "https://news.gastro.org/issues/2026/september-2026/colonoscopy-screening-lowered-colorectal-cancer-incidence-19-over-13-years/",
