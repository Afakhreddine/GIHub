...
const INIT_PROMPTS = {
  ASGE:  `Fetch https://www.asge.org/home/resources/publications/guidelines and extract ALL guidelines listed on that page. Do NOT follow any individual guideline links. For each entry, extract the full title, publication year and month, and the direct URL — all of which are visible on the listing page itself. Write a 1-2 sentence summary derived from the title. Return ONLY a JSON array. Each item: ${JSON_SCHEMA}`,
  AASLD: `Fetch https://www.aasld.org/practice-guidelines and extract ALL clinical practice guidelines listed on that page. Do NOT follow any individual guideline links. For each entry, extract the full title, publication year and month, and the direct URL — all of which are visible on the listing page itself. Write a 1-2 sentence summary derived from the title. Return ONLY a JSON array. Each item: ${JSON_SCHEMA}`,
  ...
  ACG:   `Fetch https://gi.org/guidelines and extract ALL ACG clinical guidelines and clinical practice updates listed on that page. Do NOT follow any individual guideline links. For each entry, extract the full title, publication year and month, and the direct URL — all of which are visible on the listing page itself. Write a 1-2 sentence summary derived from the title. Return ONLY a JSON array. Each item: ${JSON_SCHEMA}`,
};
